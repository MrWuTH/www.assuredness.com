<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:91:"D:\WorkPlace\5.Linux\www.assuredness.com\public/../application/index\view\product\edit.html";i:1495468198;s:85:"D:\WorkPlace\5.Linux\www.assuredness.com\public/../application/index\view\layout.html";i:1495447912;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
            ...
            <table class="table table-bordered">
                <tr>
                    <div class="input-group padding-tb-5">
                        ...
                        <select name="form[category_id]" value="<?php echo $form['category_id']; ?>" class="form-control input-custom">
                            <option value="0" class="bg-danger font-16">Select</option>
                            <option value="1" class="bg-success font-16" <?php if($form['category_id'] == '1'): ?>selected="selected"<?php endif; ?>>春装</option>
                    ...
                    <?php if($errors['category_id']): ?>
                        ...
                        <div class="bg-danger border-radius-5 padding-5 text-center"><?php echo $errors['category_id']; ?></div>
                    <?php endif; ?>
                </tr>
                <tr>
                    <div class="input-group padding-tb-5">
                ...
                <tr>
                    <div class="input-group padding-tb-5">
                        ...
                        <input type="text" class="form-control input-custom" name="form[price]" value="<?php echo $form['price']; ?>" placeholder="0.00" aria-describedby="basic-amount">
                    </div>
                    <?php if($errors['price']): ?>
                        <div class="triangle-up margin-l-3"></div>
                        <div class="bg-danger border-radius-5 padding-5 text-center"><?php echo $errors['price']; ?></div>
                    <?php endif; ?>
                </tr>
                <tr>
                    <div class="input-group padding-tb-5">
